...
public class BrassJEI extends CreateJEI {
	...
	private void loadCategories() {
		...
		CreateRecipeCategory<?>
				...
				.catalyst(BrassBlocks.BRASS_MECHANICAL_PRESS::get)
		...
		mixing = builder(BasinRecipe.class)
				...
				.catalyst(BrassBlocks.BRASS_MECHANICAL_MIXER::get)
		...
		sawing = builder(CuttingRecipe.class)
				...
				.catalyst(BrassBlocks.BRASS_MECHANICAL_SAW::get)
		...
		deploying = builder(DeployerApplicationRecipe.class)
				...
				.catalyst(BrassBlocks.BRASS_DEPLOYER::get)
				.catalyst(BrassBlocks.BRASS_DEPOT::get)
