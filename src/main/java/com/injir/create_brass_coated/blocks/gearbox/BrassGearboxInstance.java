...
public class BrassGearboxInstance extends KineticTileInstance<BrassGearboxTileEntity> {

    protected final EnumMap<Direction, RotatingData> keys;
    protected Direction sourceFacing;

    public BrassGearboxInstance(MaterialManager modelManager, BrassGearboxTileEntity tile) {
