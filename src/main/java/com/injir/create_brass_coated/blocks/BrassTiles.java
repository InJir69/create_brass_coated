...
public class BrassTiles {
    ...
    public static final BlockEntityEntry<BrassChuteTileEntity> BRASS_CHUTE = Create_Brass_Coated.registrate()
            .tileEntity("brass_chute", BrassChuteTileEntity::new)
            .validBlocks(BrassBlocks.BRASS_CHUTE)
            .renderer(() -> BrassChuteRenderer::new)
            .register();

    public static final BlockEntityEntry<BrassSmartChuteTileEntity> SMART_BRASS_CHUTE = Create_Brass_Coated.registrate()
    ...
    public static final BlockEntityEntry<BrassPipeTileEntity> BRASS_PIPE = Create_Brass_Coated.registrate()
            .tileEntity("brass_pipe", BrassPipeTileEntity::new)
            .validBlocks(BrassBlocks.BRASS_PIPE)
            .register();

    public static final BlockEntityEntry<BrassPipeTileEntity> ENCASED_BRASS_PIPE = Create_Brass_Coated.registrate()
            .tileEntity("encased_brass_pipe", BrassPipeTileEntity::new)
            .validBlocks(BrassBlocks.ENCASED_BRASS_PIPE)
            .register();

    public static final BlockEntityEntry<StraightBrassPipeTileEntity> GLASS_BRASS_PIPE = Create_Brass_Coated.registrate()
            .tileEntity("glass_brass_pipe", StraightBrassPipeTileEntity::new)
            .validBlocks(BrassBlocks.GLASS_BRASS_PIPE)
            .renderer(() -> TransparentStraightBrassPipeRenderer::new)
            .register();

    public static final BlockEntityEntry<BrassPumpTileEntity> BRASS_MECHANICAL_PUMP = Create_Brass_Coated.registrate()
            .tileEntity("brass_mechanical_pump", BrassPumpTileEntity::new)
            .instance(() -> BrassPumpCogInstance::new)
            .validBlocks(BrassBlocks.BRASS_MECHANICAL_PUMP)
            .renderer(() -> BrassPumpRenderer::new)
            .register();

    public static final BlockEntityEntry<SmartBrassPipeTileEntity> SMART_BRASS_PIPE = Create_Brass_Coated.registrate()
            .tileEntity("smart_brass_pipe", SmartBrassPipeTileEntity::new)
            .validBlocks(BrassBlocks.SMART_BRASS_PIPE)
            .renderer(() -> SmartTileEntityRenderer::new)
            .register();

    public static final BlockEntityEntry<BrassValveTileEntity> BRASS_VALVE = Create_Brass_Coated.registrate()
            .tileEntity("brass_valve", BrassValveTileEntity::new)
            .instance(() -> BrassValveInstance::new)
            .validBlocks(BrassBlocks.BRASS_VALVE)
            .renderer(() -> BrassValveRenderer::new)
            .register();
