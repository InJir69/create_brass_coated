...
public class BrassPumpRenderer extends KineticTileEntityRenderer {

	public BrassPumpRenderer(BlockEntityRendererProvider.Context context) {
		super(context);
	}
	...
	protected void renderSafe(KineticTileEntity te, float partialTicks, PoseStack ms, MultiBufferSource buffer,
		...
		if (!(te instanceof BrassPumpTileEntity pump))
			return;
		...
		for (float yRot : new float[] { 0, 90 }) {
			Direction direction = blockState.getValue(BrassPumpBlock.FACING);
            arrow.centre()
