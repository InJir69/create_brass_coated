...
public class BrassValveRenderer extends KineticTileEntityRenderer {

	public BrassValveRenderer(BlockEntityRendererProvider.Context context) {
		super(context);
	}
	...
	protected void renderSafe(KineticTileEntity te, float partialTicks, PoseStack ms, MultiBufferSource buffer,
		...
		if (!(te instanceof BrassValveTileEntity valve))
			return;

		float pointerRotation = Mth.lerp(valve.pointer.getValue(partialTicks), 0, -90);
		Axis pipeAxis = BrassValveBlock.getPipeAxis(blockState);
