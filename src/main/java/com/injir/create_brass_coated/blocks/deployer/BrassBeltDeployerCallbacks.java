...
import com.injir.create_brass_coated.blocks.deployer.BrassDeployerTileEntity.State;
...
public class BrassBeltDeployerCallbacks {
	...
	public static ProcessingResult onItemReceived(TransportedItemStack s, TransportedItemStackHandlerBehaviour i,
		...
		BrassDeployerFakePlayer player = deployerTileEntity.getPlayer();
	...
	public static void activate(TransportedItemStack transported, TransportedItemStackHandlerBehaviour handler,
		BrassDeployerTileEntity deployerTileEntity, Recipe<?> recipe) {
	...
	private static void awardAdvancements(BrassDeployerTileEntity deployerTileEntity, ItemStack created) {
