...
public class BrassDeployerActorInstance extends ActorInstance {
	...
	public BrassDeployerActorInstance(MaterialManager materialManager, VirtualRenderWorld simulationWorld, MovementContext context) {
        ...
        BrassDeployerTileEntity.Mode mode = NBTHelper.readEnum(context.tileData, "Mode", BrassDeployerTileEntity.Mode.class);
        PartialModel handPose = BrassDeployerRenderer.getHandPose(mode);
        ...
        pole = mat.getModel(BrassPartials.BRASS_DEPLOYER_POLE, state).createInstance();
