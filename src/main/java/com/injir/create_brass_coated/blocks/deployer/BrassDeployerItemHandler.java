...
public class BrassDeployerItemHandler implements IItemHandlerModifiable {

	private BrassDeployerTileEntity te;
	private BrassDeployerFakePlayer player;

	public BrassDeployerItemHandler(BrassDeployerTileEntity te) {
		this.te = te;
