...
public class BrassPIInstance {
	...
	public BrassPIInstance(MaterialManager materialManager, BlockState blockState, BlockPos instancePos) {
	...
	public void init(boolean lit) {
		...
		middle = materialManager.defaultSolid()
				...
				.getModel(BrassPortableStorageInterfaceRenderer.getMiddleForState(blockState, lit), blockState)
				.createInstance();
		top = materialManager.defaultSolid()
				.material(Materials.TRANSFORMED)
				.getModel(BrassPortableStorageInterfaceRenderer.getTopForState(blockState), blockState)
				.createInstance();
	}
