...
public class BrassDrillActorInstance extends ActorInstance {

    ActorData drillHead;
    private final Direction facing;

    public BrassDrillActorInstance(MaterialManager materialManager, VirtualRenderWorld contraption, MovementContext context) {
        ...
        facing = state.getValue(BrassDrillBlock.FACING);
        ...
        drillHead = material.getModel(BrassPartials.BRASS_DRILL_HEAD, state).createInstance();
