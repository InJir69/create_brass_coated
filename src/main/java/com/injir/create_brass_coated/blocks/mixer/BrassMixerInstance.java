package com.injir.create_brass_coated.blocks.mixer;
...
public class BrassMixerInstance extends EncasedCogInstance implements DynamicInstance {

	private final RotatingData mixerHead;
	private final OrientedData mixerPole;
	private final BrassMechanicalMixerTileEntity mixer;

	public BrassMixerInstance(MaterialManager dispatcher, BrassMechanicalMixerTileEntity tile) {
		...
		mixerPole = getOrientedMaterial()
				.getModel(BrassPartials.BRASS_MECHANICAL_MIXER_POLE, blockState)
				.createInstance();
