...
public class BrassMechanicalMixerRenderer extends KineticTileEntityRenderer {
	...
	protected void renderSafe(KineticTileEntity te, float partialTicks, PoseStack ms, MultiBufferSource buffer,
		...
		BrassMechanicalMixerTileEntity mixer = (BrassMechanicalMixerTileEntity) te;
		...
		SuperByteBuffer poleRender = CachedBufferer.partial(BrassPartials.BRASS_MECHANICAL_MIXER_POLE, blockState);
