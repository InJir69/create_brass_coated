...
public class BrassBracketBlockItem extends BlockItem {

	public BrassBracketBlockItem(Block p_i48527_1_, Properties p_i48527_2_) {
	...
	public InteractionResult useOn(UseOnContext context) {
		...
		BrassBracketBlock bracketBlock = getBracketBlock();
		Player player = context.getPlayer();

		BracketedTileEntityBehaviour behaviour = BrassTileEntityBehaviour.get(world, pos, BracketedTileEntityBehaviour.TYPE);
	...
	private BrassBracketBlock getBracketBlock() {
		return (BrassBracketBlock) getBlock();
	}
