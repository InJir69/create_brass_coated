...
public class BrassDepotRenderer extends SafeTileEntityRenderer<BrassDepotTileEntity> {

	public BrassDepotRenderer(BlockEntityRendererProvider.Context context) {
	}

	@Override
	protected void renderSafe(BrassDepotTileEntity te, float partialTicks, PoseStack ms, MultiBufferSource buffer,
	...
	public static void renderItemsOf(SmartTileEntity te, float partialTicks, PoseStack ms, MultiBufferSource buffer,
		int light, int overlay, BrassDepotBehaviour depotBehaviour) {
