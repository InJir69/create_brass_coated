...
public class BrassFanInstance extends KineticTileInstance<BrassEncasedFanTileEntity> {
    ...
    public BrassFanInstance(MaterialManager modelManager, BrassEncasedFanTileEntity tile) {
