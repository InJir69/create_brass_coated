...
public class BrassPressingBehaviour extends BeltProcessingBehaviour {
	...
	public BrassPressingBehaviourSpecifics specifics;
	...
	public interface BrassPressingBehaviourSpecifics {
	...
	public <T extends SmartTileEntity & BrassPressingBehaviourSpecifics> BrassPressingBehaviour(T te) {
		super(te);
		this.specifics = te;
		mode = Mode.WORLD;
		entityScanCooldown = ENTITY_SCAN;
		whenItemEnters((s, i) -> BrassBeltPressingCallbacks.onItemReceived(s, i, this));
		whileItemHeld((s, i) -> BrassBeltPressingCallbacks.whenItemHeld(s, i, this));
	}
