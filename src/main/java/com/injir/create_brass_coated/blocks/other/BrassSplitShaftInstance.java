...
public class BrassSplitShaftInstance extends KineticTileInstance<SplitShaftTileEntity> {

    protected final ArrayList<RotatingData> keys;

    public BrassSplitShaftInstance(MaterialManager modelManager, SplitShaftTileEntity tile) {
