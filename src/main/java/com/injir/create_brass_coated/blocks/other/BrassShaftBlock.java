...
public class BrassShaftBlock extends AbstractSimpleShaftBlock {
	...
	public InteractionResult use(BlockState state, Level world, BlockPos pos, Player player, InteractionHand hand,
		...
		if (BrassBlocks.BRASS_GIRDER.isIn(heldItem) && state.getValue(AXIS) != Axis.Y) {
		...
		public PlacementOffset getOffset(Player player, Level world, BlockState state, BlockPos pos,
			...
			if (offset.isSuccessful())
				offset.withTransform(offset.getTransform()
					.andThen(s -> BrassShaftBlock.pickCorrectShaftType(s, world, offset.getBlockPos())));
			return offset;
		}
