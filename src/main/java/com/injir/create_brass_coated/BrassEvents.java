        ...
        public static void addPackFinders(AddPackFindersEvent event) {
            if (event.getPackType() == PackType.CLIENT_RESOURCES) {
                ...
                event.addRepositorySource((consumer, constructor) -> {
                    consumer.accept(Pack.create(Create_Brass_Coated.asResource("resourcepacks/brass_shaft").toString(), false, () -> new ModFilePackResources("Create Brass Shaft", modFile, "resourcepacks/brass_shaft"), constructor, Pack.Position.TOP, PackSource.DEFAULT));
                });
            }
